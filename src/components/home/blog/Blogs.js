...
const Blogs = () => {
    ...
    return (
        <div className='max-w-screen-xl mx-auto px-5'>
            ...
            <div className='pb-10 '>
                <li className='font-bold list-decimal'>Difference between SQL and NoSQL</li>
                <p>SQL is the programming language used to interface with relational databases. (Relational databases model data as records in rows and tables with logical links between them). NoSQL is a class of DBMs that are non-relational and generally do not use SQL.</p>
                <br></br>
                <li className='font-bold list-decimal'>What is JWT, and how does it work?</li>
                ...
                <br></br>
                <li className='font-bold list-decimal'>What is the difference between javascript and NodeJS?</li>
                <p>JavaScript is a simple programming language that can be used with any browser that has the JavaScript Engine installed. Node. js, on the other hand, is an interpreter or execution environment for the JavaScript programming language</p>
                <br></br>
                <li className='font-bold list-decimal'>How does NodeJS handle multiple requests at the same time?</li>
